...
namespace Rrustam\LastModified\Tests;

use Rrustam\LastModified\Facades\LastModified;
use Rrustam\LastModified\LastModifiedServiceProvider;
use Rrustam\LastModified\Middleware\LastModifiedHandling;
